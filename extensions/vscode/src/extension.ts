...
export function activate(context: vscode.ExtensionContext): void {
  context.subscriptions.push(
    vscode.commands.registerCommand("mvvmexpress.createApp", () => runCreateApp()),
    vscode.commands.registerCommand("mvvmexpress.addPage", () => runAddPage()),
  );
}
