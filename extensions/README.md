...
| Host | File | Install |
| --- | --- | --- |
| Visual Studio Code | `dist/nuvyntralabs.mvvmexpress-1.0.1.vsix` | `code --install-extension extensions/dist/nuvyntralabs.mvvmexpress-1.0.1.vsix` |
| Visual Studio 2022+ | `dist/nuvyntralabs.MVVMExpress.VisualStudio.1.0.1.vsix` | Double-click the `.vsix`, or **Extensions → Manage Extensions → Install from VSIX…** |
