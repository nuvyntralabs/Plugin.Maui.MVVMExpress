...
- Status: **0.1.0-preview.** Core, host, Shell navigator, dialogs, validation, pagination, and testing are packed. Each packed project has README.md and llms.txt. LICENSE and CHANGELOG stay at the repo root.
