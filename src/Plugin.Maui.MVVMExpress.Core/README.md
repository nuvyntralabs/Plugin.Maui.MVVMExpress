...
Target framework: `net10.0`. Version `1.3.0`. SemVer lock from `1.0.0`: `UseAuth<TChallenge>()`, UI-thread-safe navigator helpers, `SectionHostViewModel`, `FormViewModel.Bind`, snapshot lists.
