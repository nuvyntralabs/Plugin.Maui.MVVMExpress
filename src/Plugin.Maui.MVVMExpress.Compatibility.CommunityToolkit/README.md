...
Install with `--prerelease`. Target: `net10.0`. Version `0.6.0-preview`. Prefer staying on MVVMExpress `IMessageHub` unless you already have CommunityToolkit messaging.
