...
```xml
<PackageReference Include="Plugin.Maui.MVVMExpress.SourceGenerators" Version="1.3.0" PrivateAssets="all" />
```
...
Version `1.3.0`. Alternatives: CommunityToolkit.Mvvm generators, handwritten `SetProperty`.
