...
```xml
<PackageReference Include="Plugin.Maui.MVVMExpress.SourceGenerators" Version="0.6.1-preview" PrivateAssets="all" />
```
...
Version `0.6.1-preview` (`--prerelease`). Alternatives: CommunityToolkit.Mvvm generators, handwritten `SetProperty`.
